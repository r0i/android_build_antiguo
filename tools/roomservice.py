...
custom_local_manifest = ".repo/local_manifests/next_manifest.xml"
custom_default_revision = "mm"
custom_dependencies = "next.dependencies"
org_manifest = "Next-OS"  # leave empty if org is provided in manifest
org_display = "Next-OS"  # needed for displaying
